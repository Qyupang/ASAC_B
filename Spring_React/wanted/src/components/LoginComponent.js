      ...
      <div className="Login_Body_Div">
        <div className="Login_Body_Div_Div">
          ...
          <div className="Login_Email_Div">
            <label className="Login_Email_Label">이메일</label>
            <input
          ...
          <button
            ...
            onClick={() => props.setModalOpen("2")}
          >
            이메일로 계속하기
          </button>
          <div className="Login_Text_Or_Div">
            <span className="Login_Text_Or">또는</span>
          </div>
          <ul className="Login_Icons">
            <li className="Login_Icon">
              <button>
                <svg viewBox="0 0 57 56" class="Login_Icon_Style">
                  <path
                ...
                <span className="Login_Icons_Text">Kakao</span>
              </button>
            </li>
            <li className="Login_Icon">
              <button>
                ...
                <span className="Login_Icons_Text">Facebook</span>
              </button>
            </li>
            <li className="Login_Icon">
              <button>
                ...
                <span className="Login_Icons_Text">Google</span>
              </button>
            </li>
            <li className="Login_Icon">
              <button>
                ...
                <span className="Login_Icons_Text">Apple</span>
              </button>
            </li>
          </ul>
          <div className="Login_Section_Div">
            <div className="Login_Section_Link">
              <Link
                to="/terms"
                className="Login_Section_Link_Style Login_Section_Link_Terms"
              >
                이용약관
              </Link>
              <Link to="/privacy" className="Login_Section_Link_Style">
                개인정보 처리방침
              </Link>
            </div>
            <span className="Login_Section_Text">@ Wantedlab, Inc.</span>
            <div className="Login_Section_Language">
              <img
